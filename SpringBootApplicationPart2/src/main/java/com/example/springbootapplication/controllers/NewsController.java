...
import com.example.springbootapplication.servise.NewsService;
...
public class NewsController {
    ...
    public ResponseEntity<List<NewsDTO>> getNewsByCategoryId(@PathVariable("id") Long categoryId) {
        List<NewsDTO> newsByCategory = newsService.getByCategoryId(categoryId);
